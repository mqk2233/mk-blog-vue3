...
export default {
  ...
  setup() {
    (function (name, factory) {
      ...
      let _w = window, _b = document.body, _d = document.documentElement;
      let random = function () {
      ...
      Factory.prototype = {
        constructor: Factory, setOptions: function (options) {
          ...
          try {
            ...
            this._canvas.style["background-color"] = "#f5f6f9";
          ...
          let dir = Math.round(random(1, 9)) > 5 ? "right" : "left", stop = 1000, hide = 200, min = 0 - hide,
          ...
          let ribbon = [], point1 = new Point(startx, starty), point2 = new Point(startx, starty), point3 = null,
          ...
          if (section) {
            ...
            let s = this._options.colorSaturation, l = this._options.colorBrightness,
          ...
          let i = 0, t = this._ribbons.length;
          for (; i < t; ++i) {
            if (!this._ribbons[i]) {
          ...
          for (let a = 0; a < this._ribbons.length; ++a) {
            let ribbon = this._ribbons[a], numSections = ribbon.length, numDone = 0;
